# PR #21 — Multi-judge architecture and comparison

## Purpose

Decouple evaluation from one Qwen checkpoint and compare distinct VLM families under one benchmark contract.
